#dictionary with all the products in the store and their corresponding details
products = {
...
#check for low stock and sends an alert whenever it is detected
def check_low_stock ():
...
#displays the products in the products dictionary
...
# function to remove a single item from the cart or clear the entire cart
...
#function that enables viewing of the shopping cart
def view_cart ():
    print("+++++ CURRENT CART +++++")
...
# function for generating a formatted receipt
...
#Main Menu or main loop of the program
while True:
    print("==============================")
